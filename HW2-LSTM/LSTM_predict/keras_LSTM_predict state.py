...
print(my_data[1, :])
X_train = my_data[1:TRAIN_TEST_SEP, 0:4]
X_test = my_data[TRAIN_TEST_SEP:66001, 0:4].reshape(
    (-1, TIME_STEPS, INPUT_SIZE))[0:50]
y_train = my_data[1:TRAIN_TEST_SEP, 4]
y_test = my_data[TRAIN_TEST_SEP:66001, 4].reshape(
    (-1, TIME_STEPS, 1))[0:50]
